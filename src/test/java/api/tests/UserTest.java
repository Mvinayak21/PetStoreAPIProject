...
public class UserTest {
	...
	public void testGetUser()
	{
		...
		Response response = UserEndPoints.retriewUser(this.userPayload.getUsername());
	...
	public void testUpdateUser() 
	{
       ...
       Response AfterUpdateresponse = UserEndPoints.retriewUser(this.userPayload.getUsername());
